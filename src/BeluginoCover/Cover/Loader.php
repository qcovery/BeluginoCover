...
class Loader extends \VuFind\Cover\Loader
{
    ...
    public function __construct($config, ApiManager $manager,
        ...
        $this->belugaConfig = parse_ini_file(realpath(getenv('VUFIND_LOCAL_DIR') . '/config/vufind/BeluginoCover.ini'), true);
    }
            ...
            if (isset($this->belugaConfig['belugino'])) {
                if (isset($settings['format'])) {
                    ...
                    if ($im = imagecreate(64, 64)) {
                        $beluginoFile = APPLICATION_PATH . '/themes/beluginocover/css/belugino.css';
                        ...
                        imagettftext($im, 64,0,-10,72, $textcolor, APPLICATION_PATH . '/themes/beluginocover/css/fonts/belugino.ttf', $formatString);
